...
namespace GUI
{
    public partial class f_doituong : Form
    {
        ...
        {
            InitializeComponent();
            gridControl1.DataSource = new KetNoiDBDataContext().doituongs;
        ...
        private void f_doituong_Load(object sender, EventArgs e)
        {
            ...
            Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Đối Tượng");
