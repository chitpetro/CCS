...
namespace Lotus
{
    public static class MsgBox
    {
        ...
        public static DialogResult ShowErrorDialog(string text)
        {
            ...
            // ....
            var s = LanguageHelper.TranslateMsgString(text, text);
            var t = LanguageHelper.TranslateMsgString("Thông báo - ແຈ້ງການ", "Thông báo - ແຈ້ງການ");
        ...
        public static DialogResult ShowYesNoCancelDialog(string text)
        {
            // dich chuỗi text trước khi hiện ra 
            var s = LanguageHelper.TranslateMsgString(text, text);
            var t = LanguageHelper.TranslateMsgString("Xác nhận - ຢືນຢັນ", "Xác nhận - ຢືນຢັນ");
        ...
        {
            var b = new DialogResult[buttons.Length];
            for (var i = 0; i < buttons.Length; i++)
                b[i] = buttons[i].Button;

            var f = new CustomBox(buttons);
            return f.ShowMessageBoxDialog(new XtraMessageBoxArgs(
