...
namespace GUI
{
    public partial class f_tinhtrang : Form
    {
        ...
        {
            InitializeComponent();
            gridControl1.DataSource = new KetNoiDBDataContext().tinhtrangs;
        ...
        {
            if (MsgBox.ShowYesNoCancelDialog("Bạn có chắc chắn muốn xóa Tình Trạng này không?") == DialogResult.Yes)
            {
        ...
        private void f_doituong_Load(object sender, EventArgs e)
        {
            ...
            Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Tình Trạng");
