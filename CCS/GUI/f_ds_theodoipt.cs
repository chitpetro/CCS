...
namespace GUI
{
    public partial class f_ds_theodoipt : Form
    {
        ...
        public void loaddata(DateTime tungay, DateTime denngay)
        {
            ...
            try
            {
                var lst = from a in db.theodoi_phuongtiens
                    ...
                    join c in db.donvis on a.iddv equals c.id
                    join d in db.congtrinhs on a.madv equals d.id
                    where
        ...
        private void gridView1_RowClick(object sender, RowClickEventArgs e)
        {
            ...
            {
                Biencucbo.getID = 1;
                Biencucbo.ma = gridView1.GetFocusedRowCellValue("mapt").ToString();
                Close();
            }
        }
        ...
        private void btnIN_Click(object sender, EventArgs e)
        {
            ...
            gridView1.Columns["mapt"].Visible = true;
