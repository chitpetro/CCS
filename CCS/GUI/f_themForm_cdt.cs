...
namespace GUI
{
    public partial class f_themForm_cdt : Form
    {
        private string a = "";
        ...
        private void load()
        {
            var lst = from a in db.filehd_cdts
                join b in db.hopdong_cdts
        ...
        private void btnluu_ItemClick(object sender, ItemClickEventArgs e)
        {
            if (Biencucbo.fhd == 0)
            {
                ...
                try
                {
                    var check = "FHD_CDT" + Biencucbo.donvi.Trim();
                    ...
                    db.filehd_cdts.InsertOnSubmit(filehd);
                    db.SubmitChanges();
                    txtlink.Text = "";
                    txtname.Text = "";
                    txtdiengiai.Text = "";
        ...
        private void btnxoa_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            {
                var a1 = gridView1.GetFocusedRowCellValue("id").ToString();
                var fhd = (from tb in db.filehd_cdts select tb).Single(t => t.id == a1);
                db.filehd_cdts.DeleteOnSubmit(fhd);
                db.SubmitChanges();
                load();
            }
        }
