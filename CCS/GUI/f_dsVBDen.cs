...
namespace GUI
{
    public partial class f_dsVBDen : Form
    {
        ...
        public void loaddata(DateTime tungay, DateTime denngay)
        {
            ...
            try
            {
                var lst = from a in db.vanbandens
                    ...
                    where a.noibo == false && a.iddv == Biencucbo.donvi
                    where
                        a.ngaynhan >= tungay && a.ngaynhan <= denngay
                    select new
                    {
                        a.id,
                        a.ngaynhan,
        ...
        private void btnin_Click(object sender, EventArgs e)
        {
            var lst = from a in db.vanbandens
                ...
                where a.noibo == false && a.iddv == Biencucbo.donvi
                where
                    a.ngaynhan >= tungay.DateTime && a.ngaynhan <= denngay.DateTime && a.ghichu == txtnxl.Text
                select new
                {
                    a.id,
                    a.ngaynhan,
            ...
            Biencucbo.title = "THỐNG KÊ HỒ SƠ ĐẾN";
            var r = new r_dsVbDen();
