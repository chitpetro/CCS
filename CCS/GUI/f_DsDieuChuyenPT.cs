...
namespace GUI
{
    public partial class f_DsDieuChuyenPT : Form
    {
        ...
        public void loaddata(DateTime tungay, DateTime denngay)
        {
            ...
            try
            {
                var lst = from a in db.lichsu_phuongtiens
                    join b in db.phuongtiens
                        on a.id equals b.id
                    join d in db.donvis
        ...
        private void f_PN_Load(object sender, EventArgs e)
        {
            ...
            Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Danh Sách Điều Chuyển Phương Tiện");
        ...
        private void btnIN_Click(object sender, EventArgs e)
        {
            ...
            var report = new r_DsDieuChuyenPT();
        ...
        private void btnxoa_Click(object sender, EventArgs e)
        {
            if (Biencucbo.sua)
            {
                ...
                {
                    if (
                        MsgBox.ShowYesNoCancelDialog("Bạn có chắc chắn muốn xóa DS Điều Chuyển Phương Tiện này không?") ==
                        DialogResult.Yes)
                    {
