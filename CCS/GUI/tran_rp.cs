...
namespace GUI
{
    public static class tran_rp
    {
        ...
        public static void tran_ngay(XRTableCell ngay2, XRPageInfo xrPageInfo2)
        {
            ...
            {
                ngay2.Text = "ວັນທີ່ " + DateTime.Now.Day + ", ເດືອນ " + DateTime.Now.Month + ", ປີ " +
                             DateTime.Now.Year;
        ...
        public static void tran1(XRLabel txtdv, XRLabel txttaikhoan, XRLabel txttime, XRTableCell ngay2,
            XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
        ...
        public static void tran3(XRLabel txtkho, XRLabel txtdoituong, XRLabel txttime, XRTableCell ngay2,
            XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
        ...
        //r_chitietnhapxuat
        public static void tran4(XRLabel txtkho, XRLabel txtsp, XRLabel txttime, XRTableCell ngay2,
            XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
        ...
        public static void tran5(XRLabel txtsp, XRLabel txtkho, XRLabel txttime, XRTableCell ngay2,
            XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
        ...
        public static void tran6(XRLabel txtkho, XRLabel txtloai, XRLabel txtdoituong, XRLabel txtcongviec,
            XRLabel txtmuccp, XRLabel txttime, XRTableCell ngay2, XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
                txtkho.Text = "Đơn vị: " + Biencucbo.kho;
        ...
        public static void tran7(XRLabel txtkho, XRLabel txtloai, XRLabel txtdoituong, XRLabel txtcongviec,
            XRLabel txtmuccp, XRLabel txttime, XRTableCell ngay2, XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
        ...
        public static void tran8(XRLabel txtsp, XRLabel txtkho, XRLabel txtdoituong, XRLabel txtcongviec,
            XRLabel txtloainhap, XRLabel txttime, XRTableCell ngay2, XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
                txtsp.Text = "Nhóm hàng hóa: " + Biencucbo.sp;
        ...
        public static void tran9(XRLabel txtsp, XRLabel txtkho, XRLabel txtdoituong, XRLabel txtcongviec,
            XRLabel txtloaixuat, XRLabel txttime, XRTableCell ngay2, XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
                txtsp.Text = "Nhóm hàng hóa: " + Biencucbo.sp;
        ...
        public static void tran10(XRLabel txtkho, XRLabel txtloai, XRLabel txtdoituong, XRLabel txtcongviec,
            XRLabel txtmuccp, XRLabel txttitle, XRTableCell txttktl, XRLabel txttaikhoan, XRLabel txttime,
            XRTableCell ngay2, XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
                txtkho.Text = "Đơn vị: " + Biencucbo.kho;
        ...
        //r_chitiettaikhoan
        public static void tran11(XRLabel txtdv, XRLabel txttaikhoan, XRLabel txtdoituong, XRLabel txtcongviec,
            XRLabel txtmuccp, XRLabel txttime, XRTableCell ngay2, XRPageInfo xrPageInfo2)
        {
            if (Language == LanguageEnum.Vietnam)
            {
