...
namespace GUI
{
    public partial class f_congviec : RibbonForm
    {
        ...
        {
            InitializeComponent();
            gridControl1.DataSource = new KetNoiDBDataContext().congviecs;
        ...
        {
            if (MsgBox.ShowYesNoCancelDialog("Bạn có chắc chắn muốn xóa Công Việc này không?") == DialogResult.Yes)
            {
        ...
        private void f_doituong_Load(object sender, EventArgs e)
        {
            ...
            Text = LanguageHelper.TranslateMsgString("." + Name + "_title", "Công Việc");
