...
using r_pchi = GUI.report.chiphikhac.r_pchi;

namespace GUI.Report.PhuongTien
{
    public partial class f_bccpk : Form
    {
        ...
        private void danhmuc_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (danhmuc.Text == "Loại Chi")
            {
                try
                {
                    var lst = from a in db.dmpchis
                        select new {id = a.danhmuc, name = a.danhmuc_l, key = a.danhmuc + danhmuc.Text + Biencucbo.idnv};
                    nguon.DataSource = _tTodatatable.addlst(lst.ToList());
        ...
        private void simpleButton5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var lst = from a in db.r_pchis
                    ...
                    where a.ngaychi >= tungay.DateTime && a.ngaychi <= denngay.DateTime && d.ht != true
                    select new
                    {
                        a.id,
                        ttcongtrinh =
                        ...
                        a.link,
                        a.tiente,
                        nguyentebch = a.nguyentebch == null ? 0 : a.nguyentebch*a.tygia,
                        nguyentecn = a.nguyentecn == null ? 0 : a.nguyentecn*a.tygia,
                        nguyentect = a.nguyentect == null ? 0 : a.nguyentect*a.tygia,
                        sotien = a.sotien == null ? 0 : a.sotien*a.tygia
                    };
                ...
                {
                    lst2 = from a in lst
                        join b in db.dk_rps on a.idlc equals b.id
