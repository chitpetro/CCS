...
{
    public partial class f_bcthcpall : Form
    {
        ...
        private void btnall_Click(object sender, EventArgs e)
        {
            ...
            if (ts.IsOn)
            {
                try
                {
                    ...
                    var lst = from a in db.r_bccpalls
                        select new
                        {
                            a.tencongtrinh,
                            a.idct,
                            ...
                            dv = a.khuvuc,
                            vt = a.pn == null ? 0 : a.pn,
                            hd = a.gttt == null ? 0 : a.gttt,
                            cpm = a.cpm == null ? 0 : a.cpm,
                            cpk = a.cpk == null ? 0 : a.cpk,
                            tong =
                                (a.pn == null ? 0 : a.pn) + (a.gttt == null ? 0 : a.gttt) + (a.cpm == null ? 0 : a.cpm) +
                                (a.cpk == null ? 0 : a.cpk)
                        };
                    ...
                    Biencucbo.tit = "TỔNG HỢP GIÁ TRỊ THANH TOÁN CHI PHÍ TẤT CẢ CÁC CÔNG TRÌNH";

                    var xtra = new r_bcthcpall();
                ...
                try
                {
                    ...
                    var lst = from a in db.r_bccpalls
                        select new
                        {
                            ...
                            dv = a.khuvuc,
                            vt = a.pn == null ? 0 : a.pn,
                            hd = a.gtqt == null ? 0 : a.gtqt,
                            cpm = a.cpm == null ? 0 : a.cpm,
                            cpk = a.cpk == null ? 0 : a.cpk,
                            tong =
                                (a.pn == null ? 0 : a.pn) + (a.gtqt == null ? 0 : a.gtqt) + (a.cpm == null ? 0 : a.cpm) +
                                (a.cpk == null ? 0 : a.cpk)
                        };
                    ...
                    Biencucbo.tit = "TỔNG HỢP GIÁ TRỊ QUYẾT TOÁN CHI PHÍ TẤT CẢ CÁC CÔNG TRÌNH";
