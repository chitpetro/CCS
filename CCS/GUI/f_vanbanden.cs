...
namespace GUI
{
    public partial class f_vanbanden : Form
    {
                    ...
                    //else //them moi rong
                    {
                        ...
                        try
                        {
                            ...
                            vbd.moivbd(txtid.Text.Trim(), txtdv.Text, txtIdLoai.Text, txtNgaynhan.DateTime, txtidnv.Text,
                                ...
                                Convert.ToInt32(txt1.Text), false, false, txtghichu.Text, txtlydo.Text, txttenct.Text, txttendoitac.Text);

                            ls.moi(txtid.Text, txtid.Text, 1, txtiddt.Text, txtNgaynhan.DateTime, txtidnv.Text,
                                txtid.Text, Biencucbo.donvi, Biencucbo.donvi, txtghichu.Text);
        ...
        private void btndown_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var row2 = gridView1.GetFocusedRow() as filevbden;
                if (row2 == null) return;

                var a2 = row2.id;
                var lst2 = (from a in db.filevbdens select a).Single(x => x.id == a2);
        ...
        private void f_vanbanden_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control)
            {
                if (e.KeyCode == Keys.O)
