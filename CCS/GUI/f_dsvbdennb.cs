...
namespace GUI
{
    public partial class f_dsvbdennb : Form
    {
        ...
        public void loaddata(DateTime tungay, DateTime denngay)
        {
            ...
            try
            {
                var lst = from a in db.vanbandens
                    ...
                    where a.noibo == true &&
                          a.ngaynhan >= tungay && a.ngaynhan <= denngay && a.iddv == Biencucbo.donvi
                    select new
                    {
                        a.id,
                        a.ngaynhan,
        ...
        private void btnin_Click(object sender, EventArgs e)
        {
            var lst = from a in db.vanbandens
                ...
                //join e in db.loaivanbans on a.loaivb equals e.id
                where a.noibo == true &&
                      a.ngaynhan >= tungay.DateTime && a.ngaynhan <= denngay.DateTime && a.iddv == Biencucbo.donvi &&
            ...
            Biencucbo.title = "THỐNG KÊ HỒ SƠ ĐẾN NỘI BỘ";
